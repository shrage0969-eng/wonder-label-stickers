...
(function () {
  ...
  const cityOptions = [
    ['','No default city'],['בית שמש','בית שמש'],['ירושלים','ירושלים'],['ביתר עילית','ביתר עילית'],['בני ברק','בני ברק'],
    ['מודיעין עילית','מודיעין עילית'],['רמת גן','רמת גן'],['פתח תקווה','פתח תקווה'],['אשדוד','אשדוד'],['חיפה','חיפה'],
    ['נתניה','נתניה'],['אלעד','אלעד'],['טבריה','טבריה'],['צפת','צפת'],['באר שבע','באר שבע'],['תל אביב-יפו','תל אביב-יפו']
  ];
